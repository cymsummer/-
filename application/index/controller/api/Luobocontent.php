...
class Luobocontent extends Base
{
    /*
    * 获取文章信息
    * */
    public function getinfo()
    {
        ...
        foreach ($info["data"] as $k => $v) {
           ...
           // $info["data"][$k]["new_luobo_cover_img"] = substr($v["luobo_cover_img"], 0,strrpos($v["luobo_cover_img"], "upload")) . substr($v["luobo_cover_img"], strrpos($v["luobo_cover_img"], "/")+1);
